      ...
      <div className={clsx('container', s.homePage)}>
        ...
        <div className={s.wrapper}>
          <div className={s.about}>
            <img src={sloth} alt="sloth" width={346} className={s.img} />
            <div className={s.descriptionText}>
              <p className={s.text}>
                Вітаю! Я, Скобліков Станіслав, і цей додаток я створив на React у рамках мого
                навчання на курсах Frontend-розробки. <br /> Він дозволяє зручно зберігати,
                додавати, редагувати, видаляти та фільтрувати контакти. Основна мета - використовуючи сучасний стек
                технологій забезпечити комфортну взаємодію з додатком.
              </p>
            </div>
          </div>
